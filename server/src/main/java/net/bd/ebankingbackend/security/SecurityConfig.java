...
public class SecurityConfig {
    ...
    public InMemoryUserDetailsManager inMemoryUserDetailsManager(){
        ...
        return new InMemoryUserDetailsManager(
                ...
                User.withUsername("user1").password(passwordEncoder().encode("log123@")).authorities("USER").build(),
                User.withUsername("admin").password(passwordEncoder().encode("log123@")).authorities("USER", "ADMIN").build()
        );
